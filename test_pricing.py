...
print(f'✅ Base: {pricing["base_amount"]} | Promo: {pricing["promo_discount"]} | Service Fee: {pricing["platform_fee"]} | Total: {pricing["total_payable"]}')

# Test with promo
print(f'\n=== TEST 2: Base + Promo + Service Fee ===')
...
print(f'✅ Base: {pricing["base_amount"]} | Promo: {pricing["promo_discount"]} | Subtotal: {pricing["subtotal_after_promo"]} | Service Fee: {pricing["platform_fee"]} | Total: {pricing["total_payable"]}')

# Test with wallet
print(f'\n=== TEST 3: Promo + Service Fee + Wallet ===')
...
print(f'✅ Base: {pricing["base_amount"]} | Promo: {pricing["promo_discount"]} | Subtotal: {pricing["subtotal_after_promo"]} | Service Fee: {pricing["platform_fee"]} | Total: {pricing["total_payable"]} | Wallet: {pricing["wallet_applied"]} | Gateway: {pricing["gateway_payable"]}')
